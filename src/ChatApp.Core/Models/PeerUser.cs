...
/// <summary>UI-observable model for a remote peer in the contacts list.</summary>
public partial class PeerUser : ObservableObject
{
    ...
    [ObservableProperty] private int    _grpcPort;
    [ObservableProperty] private UserStatus _status  = UserStatus.Offline;
